...
const TheGalleryOutside = (props) => {
    ...
    if(props.flags.includes("EVEMQEveWillBeAtGallery_Outside")){
        let GoToGameMap = () =>{
            props.onAddMinutes(10);
            props.onPushFlags("AMYwillShowYouAcademy");
            props.onSpliceFlag("EVEMQEveWillBeAtGallery_Outside");
        }
